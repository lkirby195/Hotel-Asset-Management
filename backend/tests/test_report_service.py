...
class TestGetInterMonth:
    ...
    def service(self):
        ...
        svc._build_waterfall_lines = AsyncMock(return_value=[ReportLineItem(id=LINE_ITEM_ID, code='test', name='Test', parent_id=None, is_summary=False, data_type='revenue', sort_order=1, depth=0, actual=100000, budget=80000, variance_dollars=20000, variance_pct=25.0, forecast_lock=90000, prior_year_actual=None, py_variance_dollars=None, py_variance_pct=None)])
